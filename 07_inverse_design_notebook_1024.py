# %% [markdown]
# # 🔮 Inverse Design Prediction (Sliding Window) - 1024×1024 Version
#
# 학습된 Inverse Design 모델로 대형 intensity map (1024×1024)으로부터  
# pillar pattern을 설계합니다.
#
# **데이터 흐름:**
# - Input: 목표 Phase Map (1024×1024 .npy)
# - Output: 설계된 Pillar Pattern (1024×1024 PNG)
#
# ## 📋 목차
# 1. 환경 설정 및 임포트
# 2. 파라미터 설정
...
# %%
# ==================== 입력 파라미터 ====================
INPUT_PHASE_PATH = 'data/forward_intensity/outputs/sample_0000.npy'  # 목표 intensity map (1024×1024)
OUTPUT_DIR = 'predictions/inverse_1024'                               # 출력 디렉토리
...
EXPERIMENT_NAME = 'inverse_design_basic_tiles_1024'
...
print("✅ 파라미터 설정 완료!")
print(f"\n📊 Inverse Design 설정 (1024×1024 버전):")
...
axes[1, 2].set_title('Probability Distribution', fontsize=11)
axes[1, 2].legend()
