# %% [markdown]
# # 🔮 Sliding Window Prediction - 1024×1024 Version
#
# 학습된 모델로 대형 이미지 (1024×1024)를 슬라이딩 윈도우 방식으로 예측합니다.
#
# ## 📋 목차
# 1. 환경 설정 및 임포트
# 2. 파라미터 설정
...
# %%
# ==================== 입력 파라미터 ====================
INPUT_MASK_PATH = 'data/forward_intensity/inputs/sample_0000.png'  # 예측할 이미지 (1024×1024)
OUTPUT_DIR = 'predictions_1024'                                    # 출력 디렉토리
...
EXPERIMENT_NAME = f'forward_phase_{MODEL_TYPE}_tiles_1024'
...
# 예측이 완료되었습니다! 🎉
#
# 결과 파일은 `predictions_1024/` 디렉토리에 저장되었습니다.
