# %% [markdown]
# # 📦 Training Tiles Generation (Sliding Window) - 1024×1024 Version
#
# 메모리 효율적인 5000×5000 nm 샘플 (1024×1024 픽셀)에서 256×256 타일을 추출합니다.
#
# ## 📋 목차
# 1. 환경 설정 및 임포트
# 2. 파라미터 설정
...
OUTPUT_DIR = 'data/forward_intensity_tiles_1024'  # 타일 출력 디렉토리
TILE_SIZE = 256                          # 타일 크기
NUM_TILES_PER_SAMPLE = 250               # 샘플당 타일 개수 (1024×1024이므로 감소)
                                         # 1024/256 = 4, 최대 16개 non-overlap 가능
                                         # 250개 = overlap 포함하여 충분한 다양성
...
#
# **`03_train_model_notebook.py`**: U-Net 모델 학습 (DATA_PATH를 'data/forward_intensity_tiles_1024'로 설정)
