...
# %%
# ==================== 데이터 파라미터 ====================
DATA_PATH = 'data/forward_intensity_tiles_1024'  # 1024×1024 버전 타일
...
LOG_DIR = 'logs'
EXPERIMENT_NAME = f'forward_phase_{MODEL_TYPE}_tiles_1024'  # 1024 버전 실험명
...
#
# **`04_sliding_window_prediction_notebook_1024.py`**: 1024×1024 대형 이미지 예측
